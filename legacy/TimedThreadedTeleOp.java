...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="TimedThreadedTeleOp_TIMED", group="Competition")
public class TimedThreadedTeleOp extends LinearOpMode {
    ...
    public static void moveLeverFor (int time) {
        leverPower = 0.75;
        
        lever.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        lever.setPower(armPower);
      
        long endpoint = System.currentTimeMillis() + time;
        while (System.currentTimeMillis() < endpoint) {
