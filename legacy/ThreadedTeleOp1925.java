...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="ThreadedTeleOp1825", group="Competition")
public class ThreadedTeleOp1925 extends LinearOpMode {
    ...
    public enum TowerAction implements Runnable {
        ...
        GO_TO_INTAKE {
            public void run () {
                    moveArmTo(ARM_INTAKE);
                    moveWristTo(WRIST_INTAKE);
                    intake.setPower(-1.0);
                    try {
                        Thread.sleep(3000);
                    }
        ...
        SCORE_HIGH_BASKET {
            public void run () {
                    moveArmTo(ARM_SAMPLE_HIGH);
                    moveWristTo(WRIST_SAMPLE_HIGH);
            }
        },
        SCORE_SPECIMEN_HIGH {
            public void run() {
                    moveWristTo(WRIST_INIT);
                    moveArmTo(ARM_INIT);
                    moveLeverTo(LEVER_SPECIMEN_HIGH, 1.0);
            }
        },
        GRAB_SPECIMEN_WALL {
            public void run() {
                ...
                moveWristTo(WRIST_INIT);
                moveArmTo(ARM_INIT);
                moveLeverTo(LEVER_SPECIMEN_WALL, 1.0);
            }
        },
        BEFORE_SPECIMEN_HIGH {
            public void run() {
                moveWristTo(WRIST_INIT);
                moveArmTo(ARM_INIT);
                moveLeverTo(LEVER_SPECIMEN_PRESCORE);
            }
        },
        ASCEND_LEVEL_TWO {
            public void run() {
