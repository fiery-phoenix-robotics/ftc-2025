...
public class ThreadedTeleOp1925_ManualIntakev2 extends LinearOpMode {
    ...
    public static final int ARM_INTAKE_SUBMERSIBLE = 1010;
    public static final int ARM_INIT = 0;
    
    public static final int WRIST_SAMPLE_HIGH = 718;
    public static final int WRIST_INTAKE = 338;
    public static final int WRIST_INTAKE_SUBMERSIBLE = 638;
    ...
    public void runOpMode () {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.a) {
                ...
                thisButtonPressed = "right_bumper";
            }
            else if (gamepad1.left_bumper){
                thisButtonPressed = "left_bumper";
            }
            else {
                thisButtonPressed = "";
            }
            ...
            if (!lastButtonPressed.equals(thisButtonPressed)) {
                ...
                switch (thisButtonPressed) {
                    ...
                    break;
                    case "right_bumper": {
                            lastClawAction = ClawAction.TOGGLE;
                    }
                    break;
                    case "left_bumper": {
                        lastTowerAction = TowerAction.INTAKE_SUBMERSIBLE;
                    }
                    break;
                    default: {
